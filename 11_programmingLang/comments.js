...
function skipSpace(string) {
  //   let skipThis = string.match(/(\s*#.*\s*)+/);
  //  if (skipThis == null) return '';
  //  let sliceStart = skipThis.index;
  //  let sliceStop = skipThis[0].length + skipThis.index;
  //  return string.slice(sliceStart, sliceStop);

  //	I left the above in to show my working, basically I was on the right track but was returning only the undesirable part. wooooops
