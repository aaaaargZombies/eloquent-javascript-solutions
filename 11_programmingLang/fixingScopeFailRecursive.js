...
specialForms.set = (args, scope) => {
  // Your code here.
  let nextScope = Object.getPrototypeOf(scope);
  // having tried this for a while I have a feeling that nextScop is a brand new object, and as such is a new scope?
  // some quick play in the REPL and it looks like that wasn't the case. now what!?
  let value = evaluate(args[1], scope); // this is the problem, value = 50 the 1st time but there is not the second time.
  ...
  specialForms.set(args, nextScope);
};
